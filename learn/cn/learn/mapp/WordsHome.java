...
/**
 * Home object for domain model class Words.
 * @see cn.learn.mapp.Words
 * @author Hibernate Tools
 */
public class WordsHome {

	private static final Log log = LogFactory.getLog(WordsHome.class);
	...
	public void persist(Words transientInstance) {
	...
	public Words merge(Words detachedInstance) {
		...
		try {
			Words result = (Words) sessionFactory.getCurrentSession().merge(
					detachedInstance);
	...
	public Words findById(java.lang.Integer id) {
		...
		try {
			Words instance = (Words) sessionFactory.getCurrentSession().get(
					"cn.learn.mapp.Words", id);
			if (instance == null) {
	...
	public List findByExample(Words instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("cn.learn.mapp.Words")
